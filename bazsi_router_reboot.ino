...
// A modulok szamara (app_hooks.h). Fuggveny, nem nyers extern: igy a fsReady
// maga a fomodul belugye marad.
...
// ---------------------------------------------------------------------------
// AP beallito portal: a ket nagy HTTP kezelo.
//
...
bool parseConfigPost(AsyncWebServerRequest* request, ConfigDraft& d,
...
bool commitConfigDraft(const ConfigDraft& d) {
  bool saveOk = true;
...
void sendDiagnosticLog(AsyncWebServerRequest* request) {
  touchApDeadline();
